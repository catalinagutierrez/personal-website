...
const AboutMe = () => (
    <div className='about-me'>
        ...
        <div className='about-body' data-aos='fade-up'>
            ...
            prototype. It was then that I realized that software development was
            not only fun, but it's something I'm passionate about. I would work
            full time at the lab and part time as a server, yet still come home
            late at night eager to continue working on my thesis to implement
