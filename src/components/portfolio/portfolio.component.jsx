            ...
            portfolio: [
                {
                    ...
                    img: '',
                    description:
                        "In my fascination for building useful tools from scratch, I decided to take the skills I've learned on my own to build my personal website—plus, I got the chance to challenge myself to tackle web development using ReactJS.",
                },
                {
                    id: '2',
                    name: 'BLE ECG Device',
                    ...
                    alt: 'PCB Thumbnail',
                    languages: 'C',
                    tools: 'PCA10040 SDK, nRF52832',
                    software: 'Segger Embedded Studios, MATLAB, Altium',
